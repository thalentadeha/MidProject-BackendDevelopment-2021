    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="phone" class="block mt-1 w-full" type="number" name="phone" :value="old('phone')" required autocomplete="phone number" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="birth" class="block mt-1 w-full" type="date" name="birth" :value="old('date')" required />
            </div>
